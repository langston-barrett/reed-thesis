...
\begin{equation*}
  \prftree[r]{}
     {\prop{\mvar{a}}}{\prop{\mvar{b}}}{Γ,\mvar{p}:\mvar{a},Θ⊢ \mvar{q}:\mvar{b}}
     {Γ,Θ⊢\λ{v}{\mvar{q}[\mvar{p}\coloneqq v]}:\mvar{a}→\mvar{b}}.
\end{equation*}
...
\begin{align*}
  \prftree[r]{}
    ...
    {\mvar{p}:\mvar{a}→ \mvar{c}}
    {\mvar{q}:\mvar{b}→ \mvar{c}}
...
\begin{remark}\label[remark]{rmk:reverse-proof}
  ...
  \begin{equation*}
    \prftree[r]{}
      ...
      {\prftree[r]{}
        {\prftree[r]{}
          {\mvar{p}:\mvar{a}→(\mvar{b}\land\mvar{c})}
          {\mvar{q}:\mvar{a}}
          {\apply{\mvar{p}}{\mvar{q}}:\mvar{b}\land\mvar{c}}}
        {\appr{1}{(\apply{\mvar{p}}{\mvar{q}})}:\mvar{b}}}
      {\apply{\mvar{r}}{(\appr{1}{(\apply{\mvar{p}}{\mvar{q}})})} : \mvar{d}}.
...
\begin{definition}\label[definition]{def:jdeq-ipl}
  ...
  \begin{gather*}
    ...
    {\prftree[r]{\footnotesize $(→)β$}
      {\mvar{p}:\mvar{a}⊢\mvar{q}\jdeq \mvar{q}:\mvar{b}}
      {\mvar{r}:\mvar{a}}
      {\apply{(\λ{v}\mvar{q})}{\mvar{r}}\jdeq
...
\begin{lemma}\label[lemma]{lemma:limitt-universal}
  ...
  \begin{equation*}
    \weq{(A\to L(X,π))}{\∑{f:\∏{n:\N}A\to X_n}{\∏{n:\N}{π_n∘ f_{n+1}=f_n}}}
  \end{equation*}
\end{lemma}
\begin{proof}
  ...
  First, define
  \begin{gather*}
    ϕ :(A\to L(X,π)) ⟶ \∑{f:\∏{n:\N}A\to X_n}{\∏{n:\N}{π_n∘ f_{n+1}=f_n}} \\
    ϕ(g) \defeq
