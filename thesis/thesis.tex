...
constant family: 
\begin{align*}
	\Algtype_P &\longrightarrow \ttfun{FiberedAlg}(X) \\
...
\begin{definition}\label[definition]{def:fiber-preinitiality}
...
\begin{definition}\label[definition]{def:fiber-uniqueness}
