...
referring explicitly to it newfound semantics.
...
\paragraph{(Co)induction.}

One fundamental feature of proof assistants (and more
generally, functional programming languages)

One of the most generally useful tools in the
