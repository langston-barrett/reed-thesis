...
\begin{notation}\label[notation]{notation:sequent}
  ...
  \define{sequent notation}, $\vdash$ can be read ``(syntactically) entails''.}
  ...
  letters $\Gamma$, $\Delta$, and $\Theta$. Our notions of entailment will
  ...
  \begin{gather*}
    ...
    \prftree[r]{\footnotesize contr}
      {\Gamma,K,\Delta,K,\Theta\vdash J}
      {\Gamma,K,\Delta,\Theta\vdash J} \\
    \prftree[r]{\footnotesize subst}
      {\Gamma,K,\Delta\vdash J}{\Gamma\vdash K}
      {\Gamma,\Delta\vdash J}
    \qquad
    \prftree[r]{\footnotesize ex}
      {\Gamma,J,\Delta,K,\Theta \vdash L}
      {\Gamma,K,\Delta,J,\Theta \vdash L}
  \end{gather*}
...
\begin{gather*}
  \prftree[r]{}{}{\Gamma\vdash\prop{\top}}
  \qquad
  \prftree[r]{}{}{\Gamma\vdash\prop{\bot}}
  \qquad
  \prftree[r]{}
    {\prop{\Gamma\vdash\mvar{a}}}
    {\prop{\Gamma\vdash\lnot \mvar{a}}} \\
  \prftree[r]{}
     {\Gamma\vdash\prop{\mvar{a}}}{\Gamma\vdash\prop{\mvar{b}}}
     {\Gamma\vdash\prop{\mvar{a}\rightarrow \mvar{b}}}
  \qquad
  \prftree[r]{}
     {\Gamma\vdash\prop{\mvar{a}}}{\Gamma\vdash\prop{\mvar{b}}}
     {\Gamma\vdash\prop{\mvar{a}\land \mvar{b}}} \\
  \prftree[r]{}
     {\Gamma\vdash\prop{\mvar{a}}}{\Gamma\vdash\prop{\mvar{b}}}
     {\Gamma\vdash\prop{\mvar{a}\lor \mvar{b}}}
  % \prftree[r]{}
  %    {\mvar{a}\prop}{v\notin\FV(\mvar{a})}
  %    {\forall v.\mvar{a}}
  % \qquad
            ...
            {\prftree[r]{}
              ...
              {\prftree[r]{\footnotesize ex}
                {\prftree[r]{\footnotesize weak}
                  ...
                  {\mvar{h}:H,\mvar{p}:\mvar{a}\vdash\mvar{h}:H}}
