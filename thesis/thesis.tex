...
\begin{definition}
  ...
  won't play a crucial role here. A monoidal category is \define{symmetric} if
  there are additional isomorphisms $s_{A,B}:A⊗B→B⊗A$ satisfying other
  coherence conditions; and is \define{cartesian} if the monoidal product $⊗$
  coincides with the categorical product $×$.
\end{definition}
