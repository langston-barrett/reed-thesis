...
judgments \cite{martin-lof-meanings}, and touch on some of the relevant meaning
explanations \cite{martin-lof-constructive}. See \cite{modal-judgment} for a
more through exposition of these concepts.
...
(from the principle \textit{Tertium Non Datur}):

\begin{minipage}[b]{0.50\linewidth}
  \centering
  \begin{displaymath}
    \prftree[r]{\footnotesize DNE}
      {\prop{P}}{\true{\lnot\lnot P}}
      {\true{P}}
  \end{displaymath}
\end{minipage}
\begin{minipage}[b]{0.50\linewidth}
