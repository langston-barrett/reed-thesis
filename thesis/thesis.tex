...
proposition.\footnote{Why do we judge that terms are propositions, instead of
  ...
  $\true{\mvar{a}}\vdash \prop{\mvar{b}}$, expressing that $\mvar{b}$ is a
...
$\lnot\mvar{a}\defeq \mvar{a}\rightarrow\bot$ and instead worry about when we
know an implication.\footnote{This definition suggests the following ``derived
  introduction rule'' for $\bot$:
  \begin{equation*}
    \prftree[r]{}
      {\prop{\mvar{a}}}{\mvar{p}:\mvar{a}}{\mvar{q}:\lnot\mvar{a}}
      {\ttfun{whoops!}(\mvar{p},\mvar{q}):\bot}.
  \end{equation*}
  The derivation of this rule from the elimination rule for $\rightarrow$
...
non-hypothetical ones. To define the introduction rule for $\rightarrow$, we
...
\begin{equation*}
  \prftree[r]{}
     ...
     {\Gamma,\Theta\vdash\lam{v}\mvar{q}[\mvar{p}\coloneqq v]:\mvar{a}\rightarrow\mvar{b}}.
\end{equation*}
  ...
  \begin{equation*}
    \prftree[r]{}
      {\prftree[r]{}
        ...
        {\appr{2}{\mvar{p}}:\mvar{b}}}
      {\prftree[r]{}
        {\mvar{p}:\mvar{a}\land\mvar{b}}
        {\appr{1}{\mvar{p}}:\mvar{a}}}
      {(\appr{2}{\mvar{p}},\appr{1}{\mvar{p}}):\mvar{b}\land\mvar{a}}
  \end{equation*}
...
\begin{definition}\label[definition]{def:lem-dne}
  ...
  \begin{equation*}
    \prftree[r]{\footnotesize LEM}
      {\prop{\mvar{a}}}
      {\apply{\ttfun{lem}}{\mvar{a}}:\true{\mvar{a}\lor\lnot\mvar{a}}}.
  \end{equation*}
...
\begin{example}\label[example]{ex:ipl-not-not-lem}
  ...
  its negation doesn't either. While reading this proof, keep the following in
  mind:
  \begin{itemize}
    \itemsep0em
            ...
            {\prftree[r]{}
              {\prftree[r]{\footnotesize weak}
                {\prftree[r]{}
                  ...
                  {\mvar{p}:\mvar{a}\vdash\apply{\inl}{\mvar{p}}:\mvar{a}\lor\lnot\mvar{a}}}
                {\mvar{p}:\mvar{a},\mvar{h}:H\vdash\apply{\inl}{\mvar{p}}:\mvar{a}\lor\lnot\mvar{a}}}
              {\prftree[r]{\footnotesize weak}
                {\prftree[r]{\footnotesize refl}
                  {\mvar{h}:H\vdash\mvar{h}:H}}
                {\mvar{p}:\mvar{a},\mvar{h}:H\vdash\mvar{h}:H}}
              {\mvar{p}:\mvar{a},\mvar{h}:H\vdash\apply{\mvar{h}}{(\apply{\inl}{\mvar{p}})}:\bot}}
            {\mvar{h}:H\vdash\lam{v}\apply{\mvar{h}}{(\apply{\inl}{v})}:\lnot\mvar{a}}}
          {\mvar{h}:H\vdash\apply{\inr}{(\lam{v}\apply{\mvar{h}}{(\apply{\inl}{v})})}:\mvar{a}\lor\lnot \mvar{a}}}
        {\prftree[r]{\footnotesize refl}
          {\mvar{h}:H\vdash\mvar{h}:H}}
        {\mvar{h}:H\vdash \apply{\mvar{h}}{(\inr(\lam{v}\apply{\mvar{h}}{(\apply{\inl}{v})}))}:\bot}}
      {\vdash\lam{w}\apply{w}{(\inr(\lam{v}\apply{w}{(\apply{\inl}{v})}))}:\lnot (\lnot(\mvar{a}\lor\lnot \mvar{a}))}
  }
  \end{center}
...
\begin{remark}\label[remark]{rmk:reverse-proof}
  ...
  \begin{equation*}
      {\apply{\mvar{r}}{(\appr{1}{(\apply{\mvar{p}}{\mvar{q}})})} : \mvar{d}}.
  \end{equation*}
  Well, it certainly had to end with an application of implication eliimination
  to hypotheses of the form $\mvar{b}$ and $\mvar{b}\rightarrow \mvar{d}$:
  \begin{equation*}
    \prftree[r]{}
      {\mvar{r}:\mvar{b}\rightarrow\mvar{d}}
      {\prftree[r]{}
        {?}
        {\appr{1}{(\apply{\mvar{p}}{\mvar{q}})}:\mvar{b}}}
      {\apply{\mvar{r}}{(\appr{1}{(\apply{\mvar{p}}{\mvar{q}})})} : \mvar{d}}.
  \end{equation*}
  ...
  \begin{equation*}
    \prftree[r]{}
      ...
      {\prftree[r]{}
        {\prftree[r]{}
          {?}
          {\apply{\mvar{p}}{\mvar{q}}:\mvar{b}\land\mvar{c}}}
        {\appr{1}{(\apply{\mvar{p}}{\mvar{q}})}:\mvar{b}}}
      {\apply{\mvar{r}}{(\appr{1}{(\apply{\mvar{p}}{\mvar{q}})})} : \mvar{d}}.
  \end{equation*}
  which itself had to be applied to proofs of $\mvar{a}$ and
  $\mvar{a}\rightarrow\mvar{b}\land\mvar{c}$ for some $\mvar{a}$:
  \begin{equation*}
    \prftree[r]{}
      {\mvar{r}:\mvar{b}\rightarrow\mvar{d}}
      {\prftree[r]{}
        {\prftree[r]{}
          {\mvar{p}:\mvar{a}\rightarrow(\mvar{b}\land\mvar{c})}
          {\mvar{q}:\mvar{a}}
          {\apply{\mvar{p}}{\mvar{q}}:\mvar{b}\land\mvar{c}}}
        {\appr{1}{(\apply{\mvar{p}}{\mvar{q}})}:\mvar{b}}}
      {\apply{\mvar{r}}{(\appr{1}{(\apply{\mvar{p}}{\mvar{q}})})} : \mvar{d}}.
...
\begin{definition}\label[definition]{def:jdeq-ipl}
  ...
  (also called \define{$\beta$-rules}):
  \setlength{\oldjot}{\jot}\addtolength{\jot}{1em}
  \begin{gather*}
    {\prftree[r]{\footnotesize $\land\beta_{\text{l}}$}
      {\mvar{p}:\mvar{a}}{\mvar{q}:\mvar{b}}
      {\appr{1}{(\mvar{p},\mvar{q})}\jdeq \mvar{p}:\mvar{a}}}
    \qquad
    {\prftree[r]{\footnotesize $\land\beta_{\text{r}}$}
      {\mvar{p}:\mvar{a}}{\mvar{q}:\mvar{b}}
      {\appr{2}{(\mvar{p},\mvar{q})}:\mvar{b}}} \\
    {\prftree[r]{\footnotesize $(\rightarrow)\beta$}
      {\mvar{p}:\mvar{a}\vdash\mvar{q}\jdeq \mvar{q}:\mvar{b}}
      {\mvar{r}:\mvar{a}}
      {\apply{(\lam{v}\mvar{q})}{\mvar{r}}\jdeq
        \mvar{q}[v\coloneqq\mvar{r}]:\mvar{b}}} \\
    {\prftree[r]{\footnotesize $\lor\beta_{\text{l}}$}
      {\mvar{p}:\mvar{a}\rightarrow\mvar{c}}
      {\mvar{q}:\mvar{b}\rightarrow\mvar{c}}
      {\mvar{r}:\mvar{a}}
      {\apppply{\case}{\mvar{p}}{\mvar{q}}{(\apply{\inl}{\mvar{r}})}\jdeq
        \apply{\mvar{p}}{\mvar{r}}:\mvar{c}}} 
    \qquad
    {\prftree[r]{\footnotesize $\lor\beta_{\text{r}}$}
      {\mvar{p}:\mvar{a}\rightarrow\mvar{c}}
      {\mvar{q}:\mvar{b}\rightarrow\mvar{c}}
      {\mvar{r}:\mvar{b}}
      {\apppply{\case}{\mvar{p}}{\mvar{q}}{(\apply{\inr}{\mvar{r}})}\jdeq
        \apply{\mvar{q}}{\mvar{r}}:\mvar{c}}}
  \end{gather*}
  \setlength{\jot}{\oldjot}
  (Recall \cref{notation:substitution} for the meaning of
  $\mvar{q}[v\coloneqq\mvar{r}]$). Since the elimination rule for
  falsehood (\cref{subsec:ipl-elim}) gives back a proof of an arbitrary
  proposition (which is not in general one of the ``inputs'' to $\intro{\bot}$),
  there's no corresponding $\beta$-rule.
\end{definition}
...
\begin{itemize}
  \itemsep0em
  \item $\ttfun{dne}:\pit{A:\universe}{(A\to\bot\to\bot)\to A}$
  \item $\ttfun{lem}:\pit{A:\universe}{A+(A\to\bot)}$
\end{itemize}
What can we tell about these functions from their type signatures?
The term $\ttfun{dne}$ takes as argument a term $x:A\to\bot\to\bot$,
