...
-- Derived from unimathsymbols.hs
...
latexToUnicode =
  ...
  , ("\\invdiameter", '⍉')
  , ("\\APLuparrowbox", '⍐')
  , ("\\APLboxupcaret", '⍓'), ("\\APLdownarrowbox", '⍗'), ("\\APLcomment", '⍝')
  , ("\\APLinput", '⍞')
  , ("\\APLlog", '⍟')
  , ("\\APLboxquestion", '⍰'), ("\\rangledownzigzagarrow", '⍼')
  , ("\\hexagon", '⎔')
  , ("\\lparenuend", '⎛')
  , ("\\lparenextender", '⎜')
  , ("\\lparenlend", '⎝')
